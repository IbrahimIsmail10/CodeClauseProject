...
public class UserMenu extends javax.swing.JFrame {
    ...
    int AccNum;
    String CardNum;
    public UserMenu(int Acc,String card) {
        initComponents();
        scalarIamges2();
        AccNum = Acc;
        CardNum = card;
        System.out.println(AccNum+"  "+ card);
    }
 private void scalarIamges2(){
    ...
    private void FASTCASHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FASTCASHActionPerformed
        ...
        JFrame FAST = new FASTCASH(AccNum);
    ...
    private void ministatementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ministatementActionPerformed
        this.setVisible(false);
        JFrame minis = new MiniStatement(AccNum);
